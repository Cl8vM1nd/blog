 ...
 * Generated for Laravel 5.3.30 on 2017-04-25.
 *
...
namespace App\Facades {
    ...
    class Cloud {
         ...
         * @static 
         */
        public static function upload($path, $name, $override = true, $visibility = 'public')
        {
            return \App\Services\CloudService::upload($path, $name, $override, $visibility);
        }
        ...
        {
            return \App\Services\CloudService::getPublicUrl($name);
        }
        ...
        {
            return \App\Services\CloudService::getFile($name);
        }
         ...
         * @static 
         */
        public static function getNameWithoutExtension($name)
        {
            return \App\Services\CloudService::getNameWithoutExtension($name);
        }
...
namespace {
    ...
    class EntityManager extends \App\Facades\EntityManager {}
    
    class Cloud extends \App\Facades\Cloud {}
